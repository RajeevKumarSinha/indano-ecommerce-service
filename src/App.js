      ...
      return (
        <Container fluid className="bg-light fixed-top shadow mb-4">
          <>
            ...
            <span className="float"><a href="https://api.whatsapp.com/send?phone=+919310364882&text=Hello%21%20Welcome%20to%20Indano%20E-commerce%20Services%20Whatsapp%20Customer%20Helpline%20." class="float" target="_blank"><Image src={Wlogo} width={"100%"} className="my-float" /></a></span>
          </>
        </Container>
      );
    }
